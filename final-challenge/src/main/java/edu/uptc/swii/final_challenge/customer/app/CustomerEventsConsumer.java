...
public class CustomerEventsConsumer {
    ...
    @KafkaListener(topics = "add-customer-topic", groupId = "customerId")
    ...
    @KafkaListener(topics = "update-customer-topic", groupId = "customerId")
    ...
    @KafkaListener(topics = "delete-customer-topic", groupId = "customerId")
